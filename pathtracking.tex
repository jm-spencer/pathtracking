...
\begin{figure}[H]
\includegraphics[width=0.6\linewidth]{images/TestVehicle}
...
\begin{figure}[H]
\includegraphics[width=0.6\linewidth]{images/GiesbrechtAckermanDiagram}
...
\begin{figure}[H]
\includegraphics[width=0.4\linewidth]{images/CoulterPurePursuitDiagram}
...
\endminipage\hfill
\minipage{0.44\textwidth}
\includegraphics[width=\linewidth]{images/pathData/ftcpath2}
\endminipage\\
\minipage{0.44\textwidth}
\includegraphics[width=\linewidth]{images/pathData/ftcpath3}
\endminipage
\end{figure}
